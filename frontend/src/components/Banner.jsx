  ...
  return (
    <div className='flex px-6 my-20 rounded-lg bg-primary sm:px-10 md:px-14 lg:px-12 md:mx-10'>
      ...
      <div className='flex-1 py-8  sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
        ...
        <button onClick={() => {navigate('/login'); scrollTo(0,0)}} className='px-8 py-3 mt-6 text-sm text-gray-600 transition-all bg-white rounded-full sm:text-base hover:scale-105'>Create account</button>
      </div>
